...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    def __init__(self, ctx: commands.Context, source: discord.FFmpegPCMAudio, *, data: dict, volume: float = 0.5, is_radio):
    ...
    @classmethod
    async def create_source(cls, ctx: commands.Context, search: str, *, loop: asyncio.BaseEventLoop = None, is_radio):
        if is_radio:
            radios = {"m80": {"title": "Rádio M80", "uploader": "M80" ,"uploader_url": 'https://m80.pt',"url": "http://stream-icy.bauermedia.pt/m80.mp3"},
                  ...
                  "m80rock": {"title": "Rádio Rock", "uploader": "M80","uploader_url": "https://m80.pt/","url": "https://stream-icy.bauermedia.pt/m80rock.aac"}}
